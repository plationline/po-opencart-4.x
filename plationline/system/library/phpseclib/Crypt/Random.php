...
if (!function_exists('phpseclib_safe_serialize')) {
    ...
    function phpseclib_safe_serialize(&$arr)
    {
        ...
        if (isset($arr['__\phpseclib_marker'])) {
            return '';
        }
        $safearr = array();
        $arr['__\phpseclib_marker'] = true;
        foreach (array_keys($arr) as $key) {
            // do not recurse on the '__\phpseclib_marker' key itself, for smaller memory usage
            if ($key !== '__\phpseclib_marker') {
                $safearr[$key] = phpseclib_safe_serialize($arr[$key]);
            }
        }
        unset($arr['__\phpseclib_marker']);
